...
/**
 * 目录文件观察类，FileAlterationObserver
 */
public class FileSQLObserver extends FileAlterationObserver implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 988609270006165599L;
	 ...
	 * 调用两个参数的构造器
	 */
	public FileSQLObserver(String directory) {
	 ...
	 * @param fileFilter
	 */
	public FileSQLObserver(File fileName, FileFilter fileFilter){
